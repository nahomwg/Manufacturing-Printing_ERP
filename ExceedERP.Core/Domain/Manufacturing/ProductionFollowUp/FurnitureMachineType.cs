...
namespace ExceedERP.Core.Domain.Manufacturing.ProductionFollowUp
{
    ...
    {
        public int FurnitureMachineId { get; set; }
        [Display(Name = "Machine Name")]
        public string MachineName { get; set; }
        [Display(Name = "Category")]
        public Furniture_Category Category { get; set; }

        [Display(Name = "Sub Category")]
        public FurnitureSub_Category SubCategory { get; set; }
    ...
    {
        public int FurnitureSettingsId { get; set; }

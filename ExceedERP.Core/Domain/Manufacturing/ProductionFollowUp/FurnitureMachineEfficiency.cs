...
{
    public class FurnitureMachineEfficiency
    {
        public int FurnitureMachineEfficiencyID { get; set; }
        ...
        public FurnitureJob_Type TypeJob { get; set; }
        ...
        public FurnitureCost_Center2 CostCenter { get; set; }

...
{
    public class FurnitureIdleTime
    {
        public int FurnitureIdleTimeID { get; set; }
        [Required]
        public int GlFiscalYearId { get; set; }
        [Required]
        public int GLPeriodId { get; set; }
        public virtual ICollection<FurnitureIdleTimeOT> FurnitureIdleTimeOT { get; set; }
        public virtual ICollection<FurnitureIdleTimeProductive> FurnitureIdleTimeProductive { get; set; }
        public virtual ICollection<FurnitureIdleTimeNonProductiveControllable> FurnitureIdleTimeNonProductiveControllable { get; set; }
        public virtual ICollection<FurnitureIdleTimeNonProductiveNonControllable> FurnitureIdleTimeNonProductiveNonControllable { get; set; } 
    }

    public class FurnitureIdleTimeOT
    {
        public int FurnitureIdleTimeOTID { get; set; }
    ...
    public class FurnitureIdleTimeProductive
    {
        public int FurnitureIdleTimeProductiveID { get; set; }
        public int IdleTimeID { get; set; }
        public virtual IdleTime IdleTime { get; set; }
        public int CostCenterId { get; set; }
        public decimal Rate { get; set; }
    ...
    public class FurnitureIdleTimeNonProductiveControllable
    {
        public int FurnitureIdleTimeNonProductiveControllableID { get; set; }
        public int IdleTimeID { get; set; }
        public virtual IdleTime IdleTime { get; set; }
        [Required]
    ...
    public class FurnitureIdleTimeNonProductiveNonControllable
    {
        public int FurnitureIdleTimeNonProductiveNonControllableID { get; set; }
        public int IdleTimeID { get; set; }
        public virtual IdleTime IdleTime { get; set; }
        [Required]
        [Display(Name = "Idle Time Description")]
    ...
    public class FurnitureIdelTimeControllabelDescription
    {
        public int FurnitureIdelTimeControllabelDescriptionID { get; set; }
        public string Name { get; set; }
        public string Discription { get; set; }
    }
    public class FurnitureIdelTimeControllabelNonDescription
    {
        public int FurnitureIdelTimeControllabelNonDescriptionID { get; set; }
        public string Name { get; set; }
        public string Discription { get; set; }
    }
}
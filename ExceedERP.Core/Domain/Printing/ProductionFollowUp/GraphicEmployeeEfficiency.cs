...
{
    public class GraphicEmployeeEfficiency
    {
        public int GraphicEmployeeEfficiencyID { get; set; }
        ...
        public CompletedJobType CompletedTypeJob { get; set; }
        ...
        public Cost_Center3 CostCenter { get; set; }

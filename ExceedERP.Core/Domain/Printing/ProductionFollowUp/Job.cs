...
{
    public class Job : TrackUserSettingOperation
    {
        ...
        public ProductionJobOrderStatus? Status { get; set; }
        ...
        [Display(Name = "Printing Line")]
        [StringLength(15)]
        public string PrintingLine { get; set; }
        [Display(Name = "Printing Machine")]
        [StringLength(15)]
        ...
        [Display(Name = "Printing Expected Completetion")]
        [DataType(DataType.Date)]
        [DisplayFormat(DataFormatString = "{0:yyyy-MM-dd}", ApplyFormatInEditMode = true)]
   ...
   public enum ProductionJobOrderStatus
    {
        Normal,
        ChangedOrder,
        ReOrdered

...
//{
//    [DataObject]
//    public class ExternalVacancyObjectDataSource
//    {
//        private ExceedDbContext db = new ExceedDbContext();

//        [DataObjectMethod(DataObjectMethodType.Select)]
//        public List<Vacancy> GetExternalVacancy()
//        {
//            List<Vacancy> list = new List<Vacancy>();
//            var vacancy = db.VaccancyPlans.Where(x => x.RecruSource == RecruitmentSource.EXTERNAL).ToList();

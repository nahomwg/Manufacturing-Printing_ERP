...
//{
//    [DataObject]
//    public class CascadedInternalJobTitleObjectDataSource
//    {
//        private ExceedDbContext db = new ExceedDbContext();

//        [DataObjectMethod(DataObjectMethodType.Select)]
//        public List<Lookup> GetInternalJobTitleCascaded(string vacancyCod, string vacancyId)
//        {
...
//                    {
//                        var vacancy = db.VaccancyPlans.FirstOrDefault(x => x.VacancyId == recruitment.VacancyId && x.RecruSource == RecruitmentSource.INTERNAL);
...
//                    var vacancy = db.VaccancyPlans.FirstOrDefault(x => x.VacancyId == recruitmentVacancy.VacancyId && x.RecruSource == RecruitmentSource.INTERNAL);

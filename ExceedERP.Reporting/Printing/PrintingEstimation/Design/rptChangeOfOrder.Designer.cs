namespace ExceedERP.Reporting.Printing.PrintingEstimation.Design
{
    ...
    "</span></p>";
            ...
            this.ChangeOfOrderODS.DataSource = typeof(ExceedERP.Reporting.Printing.PrintingEstimation.DataSource.ChangeOfOrderODS);

...
namespace ExceedERP.Web.Areas.Manufacturing.Controllers.Estimation
{
    ...
    public class FurnitureEstimationJobOrderController : Controller
    {
        ...
        {
            IQueryable<FurnitureJob> jobs = db.FurnitureJobs.Where(q => q.hv);
        ...
        public ActionResult ChangeOrders_Read([DataSourceRequest]DataSourceRequest request, int id)
        {
            ...
            DataSourceResult result = changeorders.ToDataSourceResult(request, changeOrder => new {
                FurnitureChangeOrderId = changeOrder.FurnitureChangeOrderId,
                FurnitureJobId = changeOrder.FurnitureJobId,

...

{
    ...
    public class FurnitureProductionStoreReceiveController : Controller
    {
        ...
        {
            IQueryable<FurnitureProductionFinishedGoodsStoreReceive> storeReceives = db.FurnitureProductionFinishedGoodsStoreReceives;
            DataSourceResult result = storeReceives.ToDataSourceResult(request, receive => new
            {
                FinishedGoodsStoreReceiveId = receive.FurnitureFinishedGoodsStoreReceiveId,
                ProductionPeriodId = receive.FurnitureProductionPeriodId,
                ...
                CustomerId = receive.FurnitureCustomerId,
                JobId = receive.FurnitureJobId,
        ...
        public ActionResult StoreReceive_Create([DataSourceRequest]DataSourceRequest request, FurnitureProductionFinishedGoodsStoreReceive receive)
        {
            if (ModelState.IsValid)
            {
                if (DateIsNotInRange(receive.FurnitureProductionPeriodId, receive.ReceiveDate))
                {
                ...
                else
                {
                    ...
                    {
                        FurnitureFinishedGoodsStoreReceiveId = receive.FurnitureFinishedGoodsStoreReceiveId,
                        FurnitureProductionPeriodId = receive.FurnitureProductionPeriodId,
                        StoreCode = receive.StoreCode,
                        ReceiveDate = receive.ReceiveDate,
                        Supervisor = receive.Supervisor,
                        DeliveredBy = receive.DeliveredBy,
                        ReceivedBy = receive.ReceivedBy,
                        FurnitureJobId = receive.FurnitureJobId,
                        OrgBranchName = receive.OrgBranchName,
                    ...
                    db.SaveChanges();
                    receive.FurnitureFinishedGoodsStoreReceiveId = entity.FurnitureFinishedGoodsStoreReceiveId;
        ...
        [AcceptVerbs(HttpVerbs.Post)]
        public ActionResult StoreReceive_Update([DataSourceRequest]DataSourceRequest request, FurnitureProductionFinishedGoodsStoreReceive receive)
        {
            if (ModelState.IsValid)
            {
                if (DateIsNotInRange(receive.FurnitureProductionPeriodId, receive.ReceiveDate))
        ...
        [AcceptVerbs(HttpVerbs.Post)]
        public ActionResult StoreReceive_Destroy([DataSourceRequest]DataSourceRequest request, FurnitureProductionFinishedGoodsStoreReceive receive)
        {
            if (ModelState.IsValid)
            {
                var entity = new FurnitureProductionFinishedGoodsStoreReceive
        ...
        public JsonResult SendForApproval(int id)
        {
            ...
            if (record != null && !record.IsSendForApproval && !record.IsOnlineApproved && record.ProductionFinishedGoodsStoreReceiveItems.Count > 0)
            {
                #region validate price and tax

                foreach (var item in record.ProductionFinishedGoodsStoreReceiveItems)
                {
                ...
                db.FurnitureProductionFinishedGoodsStoreReceives.Attach(record);

...

{
    ...
    public class FurnitureJobOrdersController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            ViewData["JobType"] = db.FurnitureJobCategories.Select(s => new {
                ...
                type = s.HaveParent?db.JobCategories.Where(q=>q.JobCategoryId==s.FurnitureParentId).FirstOrDefault().JobName+"-"+ s.JobName : s.JobName
            }).ToList();

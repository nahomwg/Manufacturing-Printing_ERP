...
{
    public class PrintingEstimationDataProviderController : Controller
    {
        ...
        public JsonResult GetIC()
        {
            return Json(_db.ItemCategorys.Select(s => new
            {
                Name = s.ItemCategoryCode,
